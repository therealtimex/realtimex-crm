...
export const ActivityFeed = ({
  ...
  if (!activities || activities.length === 0) {
    return (
      <div
        className={`text-center py-8 text-muted-foreground bg-muted/20 rounded-lg border border-dashed ${className}`}
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle className="text-base font-medium flex items-center gap-2">
              <span>
                {translate(`crm.activity_feed.type.${activity.type}`, {
                  _: activity.type,
                })}
              </span>
