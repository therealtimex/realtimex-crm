...
import { Brain, Code, FileJson, Activity, Terminal as TerminalIcon } from "lucide-react";
...
export const AITraceModal = ({ isOpen, onClose, activityId }: AITraceModalProps) => {
                ...
                <Tabs defaultValue="terminal" className="flex-1 flex flex-col min-h-0">
                    <div className="px-6">
                        <TabsList className="w-full">
                            <TabsTrigger value="terminal" className="flex-1 flex items-center">
