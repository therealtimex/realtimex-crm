...
interface TTSContextType {
    ...
    state: TTSState;
    playMessage: (messageId: string, text: string, settings: TTSSettings) => Promise<void>;
    pauseMessage: () => void;
    resumeMessage: () => void;
    stopMessage: () => void;
}
...
export const TTSProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const playMessage = useCallback(async (messageId: string, text: string, settings: TTSSettings) => {
        ...
        try {
            ...
            const response = await axios.post('/api/sdk/tts', {
                text,
                settings: {
